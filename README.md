...
<head>
    ...
    <title>Mountain & Nature Lab - Interactive</title>
    <style>
        :root {
        ...
        .match-box.selected { border-color: var(--secondary-color); background: #f0f7ff; }
        ...
        .word-cell { flex: 0 0 180px; font-weight: bold; color: var(--secondary-color); }
    </style>
</head>
<body>

<header>
    <h1>English Practice Lab</h1>
    <div class="score-display">Score: <span id="score-val">0</span></div>
</header>

<div class="container">
    <div class="nav-buttons">
        <button class="nav-button active" onclick="switchTab(0)">1. Study (US)</button>
    ...
    <div id="tab-1" class="exercise-section" style="display:none">
        <h2>✍️ Fill in the Gaps (Interactive)</h2>
        <div id="writing-bank" class="word-bank"></div>
        <div id="writing-content"></div>
        <button class="action-btn" onclick="checkWriting()">Check My Work</button>
    </div>
...
<script>
    const data = [
        { word: "native speaker", def: "A person who has spoken a language from childhood.", sents: ["I want to sound like a ___.", "She is a ___ of English."] },
        { word: "fifth", def: "Number 5 in a sequence.", sents: ["This is my ___ trip to the mountains.", "He finished in ___ place."] },
        { word: "an hour more", def: "60 extra minutes of something.", sents: ["In summer, we get ___ of sun.", "I need ___ to finish this."] },
        { word: "I move", def: "Relocating or changing position.", sents: ["Every time ___ , I feel tired.", "If ___ my arm, it hurts."] },
        { word: "ski resorts", def: "Winter vacation spots with hills.", sents: ["The ___ are very crowded in January.", "We stayed at one of the best ___."] },
        { word: "height", def: "How tall something is.", sents: ["What is the ___ of that mountain?", "He is afraid of ___."] },
        { word: "under", def: "Below or covered by something.", sents: ["The village is ___ the mountain.", "I hid my boots ___ the bed."] },
        { word: "peaks", def: "The very top points of a mountain.", sents: ["The snowy ___ are beautiful.", "We reached the ___ at noon."] },
        { word: "while", def: "At the same time as.", sents: ["I listened to music ___ I hiked.", "Please wait here ___ I check."] },
        { word: "without", def: "Not having something.", sents: ["Don't go ___ a jacket.", "I can't see ___ my glasses."] },
        { word: "harness", def: "Safety straps for climbing.", sents: ["Tighten your ___ before climbing.", "The ___ felt heavy."] },
        { word: "rope", def: "Thick cord for safety.", sents: ["The ___ is fifty meters long.", "Hold onto the ___ tightly."] },
        { word: "fall", def: "To drop down by accident.", sents: ["Be careful not to ___.", "The leaves ___ in autumn."] },
        { word: "view", def: "What you see from a high place.", sents: ["The ___ from the top is amazing.", "I love the ocean ___."] },
        { word: "full", def: "No more space available.", sents: ["The hotel is completely ___.", "My stomach is ___."] }
    ];
    ...
    function init() {
        ...
        // Writing - Randomized and Interactive
        ...
        shuffle(pPool);
        document.getElementById('pron-content').innerHTML = pPool.map((s, i) => `<div class="gap-sentence">${s.t.replace(s.a, '_________')} <button class="mic-btn" onclick="testSpeech('${s.a}', 'p-fb-${i}')">🎤</button><div id="p-fb-${i}" style="font-size: 0.8em; color:#888; margin-top:5px;">Check the bank & speak!</div></div>`).join('');
    }
